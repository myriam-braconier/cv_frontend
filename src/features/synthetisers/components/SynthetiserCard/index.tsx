...
export const SynthetiserCard = memo(function SynthetiserCard({ 
  ...
  return (
    <article className="bg-white flex flex-row rounded-lg shadow-lg overflow-hidden transition-all hover:shadow-xl w-full">
      <div className="flex-1 p-6">
        {image_url && !imageError && (
          <div 
            className="relative mb-4 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0" 
            style={{ height: '240px' }}
          >
            <Image
              src={image_url}
