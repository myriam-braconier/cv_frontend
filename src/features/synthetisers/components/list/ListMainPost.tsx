...
export const ListPost = memo(({ 
  ...
  synthetiserId 
   ...
   // Filtrer les posts pour n'afficher que ceux du synthétiseur sélectionné
   const filteredPosts = posts.filter(post => post.synthetiserId === synthetiserId)

  console.log("ListPost render:", { posts, showPosts, synthetiserId });

  console.log("ListPost render:", {
