    ...
    return (
        <form onSubmit={handleRegister} className="mt-8 space-y-6">
            <div className="rounded-md -space-y-px">
                <div className="mb-4">
                    <label htmlFor="username" className="block mb-2 text-orange-600">Nom d&apos;utilisateur</label>
                    <input
                        type="text"
                        id="username"
                        value={username}
                ...
                <div className="mb-4">
                    <label htmlFor="email" className="block mb-2 text-orange-600">Email</label>
                    <input
                        type="email"
                        id="email"
                        value={email}
